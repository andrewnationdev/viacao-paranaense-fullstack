  ...
  <div class="flex justify-center items-center mb-10">
    <form @submit.prevent="handleSearch"
      ...
      <div class="flex flex-col mb-4">
        <label class="text-sm font-semibold text-gray-600 mb-2 ml-1">Origem</label>
        <select v-model="origemSelecionada" :disabled="lockChanges"
          ...
          <option v-for="cidade in citiesData" :key="cidade.id" :value="cidade.id">
            {{ cidade.name }}
          </option>
        </select>
      </div>
      ...
      <div class="flex flex-col mb-4">
        <label class="text-sm font-semibold text-gray-600 mb-2 ml-1">Destino</label>
        <select v-model="destinoSelecionado" :disabled="!origemSelecionada || lockChanges"
      ...
      origemSelecionada
        ...
        : 'Selecione a origem primeiro'
          ...
          <option v-for="cidade in destinosDisponiveis" :key="cidade.id" :value="cidade.id">
            {{ cidade.name }}
          </option>
        </select>
      </div>
      ...
      <div class="flex flex-col mb-6">
        <label class="text-sm font-semibold text-gray-600 mb-2 ml-1">Data da Viagem</label>
        <input type="date" :disabled="lockChanges" v-model="dataSelecionada"
