      ...
      <div v-for="ticket in purchasedTickets" :key="ticket.id_ticket"
        ...
        <div class="flex items-center justify-between gap-2 mb-6 bg-slate-50 p-3 sm:p-4 rounded-xl">
          <div class="flex flex-col min-w-0 flex-1">
            ...
            <span class="text-[10px] text-gray-500 uppercase font-medium truncate"
              :title="cities_array[ticket.id_origin]">
          ...
          <div class="flex flex-col text-right min-w-0 flex-1">
            ...
            <span class="text-[10px] text-gray-500 uppercase font-medium truncate"
              :title="cities_array[ticket.id_destination]">
        ...
        <div
          class="flex flex-col items-center justify-center bg-white p-4 border-2 border-dashed border-gray-200 rounded-xl mb-4">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 pt-2">
          ...
          <button @click="cancelarPassagem(ticket)"
